...
# obtener los nombre de las columnas en una lista
...
# cambiar un diccionario con los valores originales de la columna
d = {'male': 'M', 'female': 'F'}
...
# Cruce de tabla o de informacion(interpolacion de columnas)
...
# Crear 2 clumnas para renderizar varias graficas
